...
-- ============================================================================
-- Flattened effect model (full card contract in one schema version)
-- ============================================================================
...
ALTER TABLE game.game_card
  ...
  ADD COLUMN IF NOT EXISTS policy_immediate_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS policy_continuous_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS core_immediate_industry_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_tech_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_population_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_green_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_carbon_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_satisfaction_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_quota_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_combo_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_industry_carbon_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_industry_carbon_reduction_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_immediate_effect jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS core_immediate_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ...
  ADD COLUMN IF NOT EXISTS core_continuous_science_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_continuous_shared_mobility_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_continuous_cross_domain_carbon_delta integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_continuous_cross_domain_combo_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_continuous_industry_carbon_offset integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_continuous_effect jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS core_continuous_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ...
  ADD COLUMN IF NOT EXISTS core_condition_min_carbon integer NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS core_condition_min_ecology_cards integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_condition_min_science_cards integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_condition_min_society_cards integer NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS core_condition_min_population integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_condition_min_satisfaction integer NOT NULL DEFAULT 0,
  ...
  ADD COLUMN IF NOT EXISTS core_condition_effect jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS core_condition_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ...
  ADD COLUMN IF NOT EXISTS core_special_ecology_carbon_sink_base_green integer NOT NULL DEFAULT 10,
  ADD COLUMN IF NOT EXISTS core_special_ecology_carbon_sink_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_special_upgrade_cost_reduction_pct integer NOT NULL DEFAULT 0,
  ADD COLUMN IF NOT EXISTS core_special_effect jsonb NOT NULL DEFAULT '{}'::jsonb,
  ADD COLUMN IF NOT EXISTS core_special_ext jsonb NOT NULL DEFAULT '{}'::jsonb,
  ...
  ADD COLUMN IF NOT EXISTS upgrade_ext jsonb NOT NULL DEFAULT '{}'::jsonb;
