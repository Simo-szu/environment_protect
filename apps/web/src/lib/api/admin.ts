...
export interface AdminCreateGameCardRequest {
  ...
  upgradeDeltaUpgradeCostPct?: number;
  upgradeExt?: Record<string, unknown>;
  upgradeReqFromStar?: number;
  upgradeReqToStar?: number;
  upgradeReqDomain1?: 'industry' | 'ecology' | 'science' | 'society';
  upgradeReqDomain1MinPct?: number;
  upgradeReqDomain2?: 'industry' | 'ecology' | 'science' | 'society';
  upgradeReqDomain2MinPct?: number;
  upgradeReqCostIndustry?: number;
  upgradeReqCostTech?: number;
  upgradeReqCostPopulation?: number;
  upgradeReqCostGreen?: number;
  upgradeReqRuleJson?: Record<string, unknown>;
  upgradeReqCostJson?: Record<string, unknown>;
  upgradeReqConfigSnapshot?: Record<string, unknown>;
  upgradeReqEnabled?: boolean;
  isEnabled?: boolean;
}
