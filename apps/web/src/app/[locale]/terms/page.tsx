            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-8 border border-white/60 dark:border-slate-800 shadow-lg">
                    <div className="prose prose-slate dark:prose-invert max-w-none">
                        <h2 className="text-xl font-semibold text-[#30499B] dark:text-blue-400 mb-4">{t('content.section1.title', '1. 服务条款的接受')}</h2>
                        <p className="text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
                            {t('content.section1.content', '欢迎使用YouthLoop环保平台！当您注册、访问或使用我们的服务时，即表示您同意遵守本用户服务协议的所有条款和条件。')}
                        </p>

                        <h2 className="text-xl font-semibold text-[#30499B] dark:text-blue-400 mb-4">{t('content.section2.title', '2. 服务描述')}</h2>
                        <p className="text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
                            {t('content.section2.content', 'YouthLoop是一个致力于环保教育和行动的在线平台，我们提供环保知识科普、活动组织、用户互动和积分奖励等服务。')}
                        </p>

                        <h2 className="text-xl font-semibold text-[#30499B] dark:text-blue-400 mb-4">{t('content.section3.title', '3. 用户责任')}</h2>
                        <p className="text-slate-700 dark:text-slate-300 mb-6 leading-relaxed">
