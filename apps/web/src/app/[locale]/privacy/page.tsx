            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-8 border border-white/60 shadow-lg">
                    <div className="prose prose-slate max-w-none">
                        <h2 className="text-xl font-semibold text-[#30499B] mb-4">{t('content.section1.title', '1. 引言')}</h2>
                        <p className="text-slate-700 mb-6 leading-relaxed">
                            {t('content.section1.content', 'YouthLoop（以下简称"我们"）非常重视用户的隐私保护。本隐私政策说明了我们如何收集、使用、存储和保护您的个人信息。使用我们的服务即表示您同意本隐私政策的条款。')}
                        </p>

                        <h2 className="text-xl font-semibold text-[#30499B] mb-4">{t('content.section2.title', '2. 我们收集的信息')}</h2>
                        <p className="text-slate-700 mb-6 leading-relaxed">
                            {t('content.section2.content', '我们收集您主动提供的信息以及自动收集的使用数据，以便为您提供更好的服务。')}
                        </p>

                        <h2 className="text-xl font-semibold text-[#30499B] mb-4">{t('content.section3.title', '3. 信息使用目的')}</h2>
                        <p className="text-slate-700 mb-6 leading-relaxed">
