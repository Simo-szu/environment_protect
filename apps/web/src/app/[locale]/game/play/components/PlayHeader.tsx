      ...
      <div className="flex items-center gap-3 shrink-0">
        <div className="flex items-center gap-1.5">
          ...
          <details className="relative">
            ...
            <div className="absolute right-0 top-full mt-3 w-44 rounded-2xl border border-slate-200 bg-white/95 backdrop-blur-xl p-2 shadow-xl z-50 flex flex-col gap-1 overflow-hidden animate-in fade-in zoom-in-95">
