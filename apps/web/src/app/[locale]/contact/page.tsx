                ...
                <div className="min-h-screen flex items-center justify-center">
                    <div className="max-w-md mx-auto text-center">
                        ...
                        <p className="text-slate-600 mb-8">
                            {t('success.message', '感谢您的联系，我们会�?4小时内回复您的消息�?)}
                        </p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-500">{t('contactInfo.phone.hours', '工作�?9:00-18:00')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400">{t('contactInfo.email.address', 'contact@youthloop.top')}</p>
                                        <p className="text-xs text-slate-500 dark:text-slate-500">{t('contactInfo.email.response', '24小时内回�?)}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-500">{t('contactInfo.address.postal', '邮编�?00020')}</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400">{t('contactInfo.hours.days', '周一至周�?)}</p>
                        ...
                        <div className="bg-gradient-to-br from-[#56B949]/10 to-[#F0A32F]/10 dark:from-[#56B949]/5 dark:to-[#F0A32F]/5 rounded-xl p-6 border border-[#56B949]/20">
                            <div className="text-center">
                                ...
                                <p className="text-sm text-slate-600 dark:text-slate-400 mb-4">
                                    {t('about.slogan', '让绿色循环，用行动改变未�?)}
                                </p>
                                <div className="flex justify-center gap-4 text-xs text-slate-500">
                                    <div className="flex items-center gap-1">
                                        <Users className="w-3 h-3" />
                                        <span>{t('about.users', '10�?用户')}</span>
                                    </div>
                                    <div className="flex items-center gap-1">
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl p-8 border border-white/60 dark:border-slate-800 shadow-lg">
                            <h3 className="text-xl font-semibold text-[#30499B] dark:text-blue-400 mb-6">{t('form.title', '发送消�?)}</h3>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            placeholder={t('form.name.placeholder', '请输入您的姓�?)}
                                            required
                                        />
                                    </div>
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-lg focus:border-[#56B949] focus:outline-none transition-colors"
                                            placeholder={t('form.email.placeholder', '请输入您的邮�?)}
                                            required
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            onChange={handleInputChange}
                                            className="w-full px-4 py-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 rounded-lg focus:border-[#56B949] focus:outline-none transition-colors"
                                            placeholder={t('form.phone.placeholder', '请输入您的电�?)}
                                        />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                                        ...
                                        >
                                            ...
                                            <option value="general">{t('form.subject.options.general', '一般咨�?)}</option>
                                            <option value="activity">{t('form.subject.options.activity', '活动相关')}</option>
                                            <option value="technical">{t('form.subject.options.technical', '技术支�?)}</option>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        placeholder={t('form.message.placeholder', '请详细描述您的问题或需�?..')}
                                        required
                                    />
                                </div>
                        ...
                        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="p-4 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-lg border border-white/40 dark:border-slate-700 text-center">
                                ...
                                <p className="font-medium text-slate-800 dark:text-slate-200 text-sm">{t('quickLinks.emergency.title', '紧急联�?)}</p>
