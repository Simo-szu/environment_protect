...
Write-Host ""
Write-Host "=== Running Game Schema Migration ===" -ForegroundColor Green
psql -h $DB_HOST -p $DB_PORT -U game_migrator -d $DB_NAME -f ..\migrations\game\V001__init_game.sql
